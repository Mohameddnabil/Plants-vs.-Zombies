...
public class MainMenu implements Screen{
    ...
    public MainMenu(Game aGame) {
        ...
        TextButton playButton = new TextButton("Play!",textbutton);
        ...
        ExitButton.setPosition(Gdx.graphics.getWidth()/2-ExitButton.getWidth()/2,Gdx.graphics.getHeight()/2-playButton.getHeight()/2-40f);
